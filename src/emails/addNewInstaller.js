                                ...
                                <tr>
                                    <td style="padding:0px;color:#153643;">
                                        ...
                                        <p
                                            ...
                                            <a href="https://seda.ivis.com.my/installer/${id}">
                                                https://seda.ivis.com.my/installer/${id}</a>
                                        </p>
                                        ...
                                        <table role="presentation"
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p
                                                        style="font-size:16px;font-family:Arial,sans-serif;padding:0px;margin:0px;">
                                                        Customer Care Email : <a
                                                            href="mailto:tech@seda.gov.my">tech@seda.gov.my</a></p>
                                                </td>
